...
test('The result of csvJson2XmlJson should be correct for a sample set of JSONified csv data', function(t) {
	t.plan(1);
	t.deepEqual(csvJson2XmlJson(data, options), result, 'Should return the correct json');
})
